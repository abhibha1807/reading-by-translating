...
args.save = '{}-{}-train-10k-wmt'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
...
train_data = dataset['train'].select(np.arange(0,11000))
...
processed_dataset_train = train_data.map(
    data_process,
    batched=True,
...
un_portion = pairs[0:10000]
# valid_portion = pairs[900:]
valid_portion = pairs[10000:]
